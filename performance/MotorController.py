...
def main():
    front_right = RightMotor(3, 4, 12)
    back_right = RightMotor(20, 21, 13)
    back_left = LeftMotor(5, 6, 19)
    front_left = LeftMotor(14, 15, 18)
    # back_left.go_ahead(100)
    # front_left.go_ahead(100)
    back_left.go_ahead(100)
    front_left.go_ahead(100)
    front_right.go_ahead(100)
    back_right.go_ahead(100)
